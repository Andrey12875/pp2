...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if clicked_color == False and clicked_shape == False:
        ...
        if event.type == pygame.MOUSEMOTION:
            if moving_circle:
                ...
                current = event.pos
                pygame.draw.circle(screen, current_color, last, int(circle_rect.width))
                last = current
    ...
    for rect in shape_buttons:
        ...
        pygame.draw.circle(screen, (0, 0, 0), rect.center, rect.width // 2, 2)
