...
many_coins_rect = coin.get_rect(topleft=(random.choice([20, 140, 260]), -200))
...
while running:
    ...
    if game_over == False:
        ...
        if player_rect.colliderect(coin_rect):
            ...
            speed += 0.1
            coin_rect.y = -700
        if many_coins_rect.y > 750:
            many_coins_rect.y = -3000
            many_coins_rect.x = random.randrange(30, 370, 30)
